...
return [
    ...
    'custom' => [
        'avatar'   => [
            'dimensions' => 'Аватар должен быть не менее 200x200 и не более 1000x1000 пикселей.',
        ],
        'banner'   => [
            'dimensions' => 'Баннер должен быть не менее 1200x300 и не более 3000x800 пикселей.',
        ],
        'name'     => [
            'regex' => 'Имя может содержать только буквы и пробелы.',
        ],
        'username' => [
            'regex' => 'Никнейм может содержать только буквы, цифры, точки, дефисы и символы подчёркивания.',
        ],
        'email'    => [
            'exists' => 'Электронная почта или пароль указаны неверно.',
